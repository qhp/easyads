...
<div class="wrapper">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{ Auth::user()->name }} @if(Auth::user()->roles[0]->name != 'client') - {{ Auth::user()->roles[0]->display_name }} @endif
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <!-- Sidebar Menu -->
            <?php Menu::make('top_menu', function($menu) {
                $menu->add('<i class="fa fa-dashboard"></i> <span>Dashboard</span>', ['route'=>'dashboard']);
            }); ?>
            <?php Menu::make('ads_campaigns_menu', function($menu) {
            ...
            <?php Menu::make('clients_menu', function($menu) {
            ...
            <?php Menu::make('system_menu', function($menu) {
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2015 <a href="#">EasyAds</a>.</strong> All rights reserved.
    </footer>
